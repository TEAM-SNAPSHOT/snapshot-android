package com.snapshot.feature.screen.home.navigation

import androidx.navigation.NavController
import androidx.navigation.NavGraphBuilder
import androidx.navigation.compose.composable
import com.snapshot.feature.screen.home.HomeScreen
import com.snapshot.feature.screen.splash.navigation.SPLASH_ROUTE

const val HOME_ROUTE = "home" // -> 현재 화면의 경로
...
fun NavGraphBuilder.homeScreen() { // -> navigateToHome이 호출됐을 떄 무슨 화면을 보여줄지를 결정하는 함수
    composable(
        route = HOME_ROUTE,
    ) {
        HomeScreen()
